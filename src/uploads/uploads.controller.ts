import { Controller, Get, Post, Body, Patch, Param, Delete, UseInterceptors, UploadedFile, ParseFilePipe, FileTypeValidator, BadRequestException } from '@nestjs/common';
...
export class UploadsController {
 ...
 async uploadImageDevice(@UploadedFile(new ParseFilePipe({
  validators:[
